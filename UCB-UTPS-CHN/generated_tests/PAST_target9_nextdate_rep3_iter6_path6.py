...
@pytest.mark.parametrize("year, month, day, expected", [
    ...
    (2020, 7, 15, "2020-07-16"),
    (9999, 12, 31, "0000-01-01"),  # 年份边界测试（注意：函数返回的是下一年，但年份超过9999时会返回错误）
    ...
    (9999, 12, 30, "10000-01-01"),  # 年份超过9999时返回错误

    # 特殊情况测试
    (2020, 2, 1, "2020-02-02"),
    (2020, 12, 1, "2020-12-02"),
    (2020, 1, 29, "2020-01-30"),
