...
class ChartGenerator:
    @staticmethod
    def plot_bar_chart(summary, targets, timestamp):
        """柱状图"""
        ...
        for i, (method, label, color) in enumerate(zip(methods, method_labels, colors)):
            ...
            for target in targets:
                if target in summary and method in summary[target]:
...
def main():
    ...
    ChartGenerator.plot_bar_chart(summary, loader.targets, timestamp)
    ...
    # 转换comparisons中的numpy类型为Python原生类型
